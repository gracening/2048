...
/**
 * Game2048GUI class manages the display
 */
    class Game2048GUI
   {
      //rows in grid
      ...
      //thickness of the border between the slots on the grid
      ...
      //settings for individual regular slot's line border
      private final LineBorder OLD_SLOT_SETTINGS = new LineBorder (Color.gray, BORDER_THICKNESS, false);
      //settings for newly randomized slot's line border     
    ...
    */
       private void initConfig()
      {
         ...
         try {
           ...
           //reading in the logo icon file
           logoIconFile = in.readLine();
           final int NUMICON = Integer.parseInt(in.readLine());
           
           slotIconFile = new String[NUMICON];
